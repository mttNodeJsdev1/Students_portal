...
export default function TypingMainTest() {
  ...
  const handleStartTest = () => {
    ...
    router.push(`/typing-test/start-test?${query}`);
  };
  return (
    <div>
      <Header />
      <div className="flex items-center justify-center flex-1 h-full ml-80 mr-80 bg-sky-300 ">
        <div className="w-full max-w-md p-8 mb-10 bg-white rounded-lg shadow-lg mt-7">
          <div className="py-3 mb-6 text-center text-white  rounded-md">
            <h2 className="text-lg italic font-semibold">Typing Test</h2>
          </div>
