...
//   const calculateAndStoreResults = useCallback(() => {
...
//       passageId: searchParams.get("passageId"),
//       language: searchParams.get("language"),
//     };

//     // Store results in localStorage
//     const previousResults = JSON.parse(
//       localStorage.getItem("typingTestResults") || "[]"
//     );
//     const updatedResults = [...previousResults, testResult];
...
//   }, [isSubmitted, calculateAndStoreResults]);
...
//     // Update current word index based on cursor position
//     const cursorPosition = e.target.selectionStart;
//     const textBeforeCursor = typedText.substring(0, cursorPosition);
//     const wordCount = textBeforeCursor.split(/\s+/).length - 1;
//     setCurrentWordIndex(wordCount);
//   };

//   // Render passage with current word highlighting
//   const renderPassage = () => {
//     const passageWords = passage.split(/\s+/);
...
//       <span
//         key={wordIndex}
//         className={`${wordIndex === currentWordIndex ? "bg-yellow-200" : ""}`}
//       >
//         {word + " "}
//       </span>
//     ));
...
//                 <textarea
//                   ref={inputRef}
//                   className="w-full h-32 p-4 font-mono text-lg border border-gray-300 rounded outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
